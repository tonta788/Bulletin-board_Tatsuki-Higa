...
Route::post('/favorite/{postId}', 'User\Post\PostFavoritesController@favorite')->name('favorite');
Route::post('/unfavorite//{postId}', 'User\Post\PostFavoritesController@unfavorite')->name('unfavorite');
